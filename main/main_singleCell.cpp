...
static void adc_read_task(void *pvParameter) {
    while (1) {
        ...
        // Read ADC values
            uint16_t adc_batteryVoltage_mV_ui16 = mcp3202_readBatteryVoltage_mA_ui16(true);
            int16_t adc_batteryCurrent_mA_si16 = mcp3202_readBatteryCurrent_mA_si16(true);
...
static void adc_periodic_timer_callback(void *arg) {
    ...
    int16_t adc_batteryCurrent_mA_si16 = 0;
